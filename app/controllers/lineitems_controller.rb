class LineitemsController < ApplicationController
  ...
  def create
    ...
    phone = Phone.find(params[:product_id])
    
    #@lineitem = @cart.lineitems.build(phone: phone)
    @lineitem = @cart.add_item(phone.id)
    
    respond_to do |format|
      if @lineitem.save
        format.html { redirect_to user_url, notice: 'Lineitem was successfully created.' }
  ...
  private
    ...
    def lineitem_params
      params.require(:lineitem).permit(:phone_id, :cart_id)
    end
end
