...
class LineitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lineitem" do
    assert_difference('Lineitem.count') do
      post lineitems_url, params: { lineitem: { cart_id: @lineitem.cart_id, phone_id: @lineitem.phone_id } }
    end
  ...
  test "should update lineitem" do
    patch lineitem_url(@lineitem), params: { lineitem: { cart_id: @lineitem.cart_id, phone_id: @lineitem.phone_id } }
